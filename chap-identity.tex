...
\section{Identity testing}
  \label{sec:identity}
%\cnote{Discuss the instance-optimal setting as well, and the relation to uniformity testing.}
%\tbc
%\begin{itemize}
