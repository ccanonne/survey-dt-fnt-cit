...
\begin{itemize}
    ...
    \item In the ``far'' case, define $\alpha$ by $\bE{\p}{Z_6} = \frac{1+\alpha^2}{\ab}$, so that $\alpha^2\geq \dst^2$ but also
    $
    ...
    \begin{align*}
        \bP{\p}{Z_6 < \tau}  
        & 
        = \bP{\p}{Z_6 <  \frac{1+\frac{1}{2}\dst^2}{1+\alpha^2} \bE{\p}{Z_6} } \\
        &\leq \bP{\p}{Z_6 <  \Paren{1 - \frac{\alpha^2}{2(1+\alpha^2)}} \bE{\p}{Z_6} } \\
        &\leq \frac{4(1+\alpha^2)^2}{\alpha^4}\cdot \frac{\Var_{\p}[Z_6]}{\bE{\p}{Z_6}^2} \\
